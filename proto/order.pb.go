...
var file_proto_order_proto_rawDesc = []byte{
	...
	0x0a, 0x75, 0x72, 0x6c, 0x49, 0x6e, 0x76, 0x6f, 0x69, 0x63, 0x65, 0x32, 0xd2, 0x0b, 0x0a, 0x0c,
...
var file_proto_order_proto_depIdxs = []int32{
	...
	0,  // 30: proto.OrderService.GetOrders:output_type -> proto.OrderBaseResponse
	0,  // 31: proto.OrderService.GetOrderDetail:output_type -> proto.OrderBaseResponse
	0,  // 32: proto.OrderService.GetOrderDetailAgent:output_type -> proto.OrderBaseResponse
	0,  // 33: proto.OrderService.CreateOrder:output_type -> proto.OrderBaseResponse
	0,  // 34: proto.OrderService.UpdateOrder:output_type -> proto.OrderBaseResponse
	0,  // 35: proto.OrderService.DeleteOrder:output_type -> proto.OrderBaseResponse
	0,  // 36: proto.OrderService.SendNotificationFirebase:output_type -> proto.OrderBaseResponse
	0,  // 37: proto.OrderService.OrderConfirm:output_type -> proto.OrderBaseResponse
	0,  // 38: proto.OrderService.CountOrderAgent:output_type -> proto.OrderBaseResponse
	0,  // 39: proto.OrderService.CountOrderNasabah:output_type -> proto.OrderBaseResponse
	0,  // 40: proto.OrderService.ConfirmAgent:output_type -> proto.OrderBaseResponse
	0,  // 41: proto.OrderService.OrderHistory:output_type -> proto.OrderBaseResponse
	0,  // 42: proto.OrderService.ChangeStatusAgent:output_type -> proto.OrderBaseResponse
	0,  // 43: proto.OrderService.ChangeStatusNasabah:output_type -> proto.OrderBaseResponse
	0,  // 44: proto.OrderService.FinishOrder:output_type -> proto.OrderBaseResponse
	0,  // 45: proto.OrderService.CancelOrder:output_type -> proto.OrderBaseResponse
	0,  // 46: proto.OrderService.DailyOrderSum:output_type -> proto.OrderBaseResponse
	0,  // 47: proto.OrderService.UpdateNominal:output_type -> proto.OrderBaseResponse
	0,  // 48: proto.OrderService.OrderCheck:output_type -> proto.OrderBaseResponse
	0,  // 49: proto.OrderService.UpdateStatusCountdown:output_type -> proto.OrderBaseResponse
	1,  // 50: proto.OrderService.ProcessOrder:output_type -> proto.OrderBaseListResponse
